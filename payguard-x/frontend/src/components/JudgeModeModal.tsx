...
export const JudgeModeModal: React.FC<JudgeModeModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/85 backdrop-blur-2xl flex items-center justify-center p-4 overflow-y-auto animate-fadeIn">
      <div className="bg-gradient-to-b from-[#0b1326] via-[#070c18] to-[#030712] border border-cyan-500/40 rounded-3xl max-w-4xl w-full p-6 md:p-8 space-y-6 shadow-2xl shadow-cyan-950/60 relative overflow-hidden">
        ...
        {!result && (
          <div className="p-8 text-center bg-[#070c18]/80 border border-white/10 rounded-3xl space-y-5 relative z-10 shadow-glass-card">
            ...
            <button
              onClick={handleRun}
              disabled={running}
              className="px-8 py-3.5 bg-gradient-to-r from-amber-400 via-red-500 to-cyan-400 hover:from-amber-300 hover:to-cyan-300 text-slate-950 font-cyber font-black text-sm uppercase tracking-wider rounded-2xl shadow-neon-amber flex items-center gap-2.5 mx-auto disabled:opacity-50 transition-all duration-200 hover:scale-105 active:scale-95"
            >
              {running ? (
                <>
        ...
        {running && !result && (
          <div className="space-y-4 relative z-10">
            ...
            <div className="w-full bg-[#030712] rounded-full h-2.5 overflow-hidden border border-white/10">
              <div
                className="bg-gradient-to-r from-amber-400 via-red-500 to-cyan-400 h-2.5 rounded-full transition-all duration-500 shadow-neon-cyan"
          ...
          <div className="space-y-5 relative z-10">
            ...
            <div className="p-5 bg-gradient-to-r from-emerald-950/40 via-[#071a12] to-cyan-950/40 border border-emerald-500/50 rounded-2xl flex items-start gap-3.5 shadow-neon-emerald">
              ...
              <div>
                ...
                <p className="text-xs text-slate-300 mt-1 leading-relaxed">{result.narrative}</p>
              </div>
            </div>
